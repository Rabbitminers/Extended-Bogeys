...
public class DoubleAxisTrailingRenderer {
    public static class MediumDoubleAxisTrailingRenderer extends BogeyRenderer {
        @Override
        public void initialiseContraptionModelData(MaterialManager materialManager, CarriageBogey carriageBogey) {
            createModelInstance(materialManager, MEDIUM_SHARED_WHEELS, 2);
            createModelInstance(materialManager, MEDIUM_4_0_4_TRAILING_FRAME);
        ...
        public void render(CompoundTag bogeyData, float wheelAngle, PoseStack ms, int light, VertexConsumer vb, boolean inContraption) {
            ...
            getTransform(MEDIUM_4_0_4_TRAILING_FRAME, ms, inContraption)
                    .render(ms, light, vb);
